...
#### [Tapswap link](https://t.me/tapswap_mirror_1_bot?start=r_896333795)
...
## Installation
You can download [**Repository**](https://github.com/Re-Diss/TapSwapBot) by cloning it to your system and installing the necessary dependencies:
```shell
~ >>> git clone https://github.com/Re-Diss/TapSwapBot.git
~ >>> cd TapSwapBot

# If you are using Telethon sessions, then clone the "converter" branch
~ >>> git clone https://github.com/Re-Diss/TapSwapBot.git -b converter
~ >>> cd TapSwapBot
